# -*- coding: utf-8 -*-
#
# openSUSE 安全指南 build configuration file, created by
...
project = u'openSUSE 安全指南'
copyright = u'2015, SUSE LLC 及贡献者'
author = u'SUSE LLC 及贡献者'
...
latex_documents = [
  (master_doc, 'TsingBrick.tex', 'openSUSE 安全指南',
...
man_pages = [
    (master_doc, 'tsingbrick', u'openSUSE 安全指南',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'TsingBrick', 'openSUSE 安全指南',
